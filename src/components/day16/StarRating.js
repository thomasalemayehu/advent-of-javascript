...
import "../../assets/day16/styles/index.css";
import { useState } from "react";
// import StarIcon from "../../assets/day16/icons/star.svg";
const StarRating = () => {
  ...
  const onHover = (id) => {
    const newStarStatus = starsStatus.slice();
    for(let i=0; i< id; i++){
      newStarStatus[i] = {
        ...newStarStatus,
    ...
    setStarsStatus(newStarStatus);

  };
  return (
    <div className="star-rating-container">
      <div className="star-rating-wrapper">
        {starsStatus.map(({ id, className }) => (
          <svg
            onMouseEnter={() => {
              onHover(id);
            }}
